...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <a href="{{ route('add.permission') }}" class="btn btn-primary mx-1"><i class="feather-16" data-feather="file-plus"></i> &nbsp; Add Permission</a>
            <a href="{{ route('import.permission') }}" class="btn btn-secondary mx-1"><i class="feather-16" data-feather="file-text"></i> &nbsp;Import</a>
            <a href="{{ route('export') }}" class="btn btn-success"><i class="feather-16" data-feather="file-minus"></i> &nbsp;Export</a>
        </ol>
    </nav>
